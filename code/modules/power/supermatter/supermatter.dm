...
/obj/machinery/power/supermatter_shard
	...
	var/warning_alert = "Danger! The supermatter crystal is very Instable, EVACUTATE INMEDIATELY."
	var/damage_penalty_point = 550
	var/emergency_point = 700
	var/emergency_alert = "CRYSTAL DELAMINATION IMMINENT. EVACUATE INMEDIATELY. THIS IS NOT A TEST."
...
/obj/machinery/power/supermatter_shard/proc/explode()
	...
	if(combined_gas > MOLE_PENALTY_THRESHOLD)
		...
		explosion(get_turf(T),0,1,0,flame_range = 1)
