/mob/living/carbon/monkey/punpun //except for a few special persistence features, pun pun is just a normal monkey
	...
	var/relic_mask
	var/memory_saved = 0
	var/list/pet_monkey_names = list("Pun Pun", "i am hilarious", "Farter", "Nooya The", "Dr. Chef", "Nuclear Fuckface", "Puns-That-Are-Byond-Shit", "Spiffo The Fucking Moron", "Hunter Carrell", "SNN", "ASM Pro", "Windows Tech Support", "Fizzy The Fucking Fuz")
	var/list/rare_pet_monkey_names = list("SuS SuS","Felipe Is A Frick","ASM Tryhard")
