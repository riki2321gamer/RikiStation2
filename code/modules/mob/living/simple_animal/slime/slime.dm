...
/mob/living/simple_animal/slime/attack_hand(mob/living/carbon/human/M)
	...
	if(extremelymad == 0)
		extremelymad = 1
		message_admins("a slime has just been extremely triggered at [src.x],[src.y],[src.z]")
		src.say("WHAT THE FUCK NIBBA!?!?!?!?!?")
		src.resize = 2
		sleep(1)
		src.resize = 2
		sleep(1)
		...
		src.resize = 2
		sleep(35)
		priority_announce("oh shit boi", "team of borks", 'sound/ambience/extremelymad.ogg')
		sleep(35)
		src.say("..I AM.. MAD!!!!!!!!!!!!!!!")
		maxHealth = 999999999
		health = 999999999
...
/mob/living/simple_animal/slime/proc/spiral_shoot(negative = 0, counter_start = 1)
...
/mob/living/simple_animal/slime/proc/shoot_projectile(turf/marker)
