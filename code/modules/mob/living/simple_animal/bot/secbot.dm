...
/mob/living/simple_animal/bot/secbot/beepsky
	name = "THOT-PATROLV2.0"
	desc = "A little robot which patrols the station for thotties."
	idcheck = 0
	weaponscheck = 0
	auto_patrol = 1
...
/mob/living/simple_animal/bot/secbot/beepsky/jr
	name = "THOT-PATROL1.5"
	desc = "The unfinished build of THOT-PATROLV2.0"
...
/mob/living/simple_animal/bot/secbot/beepsky/explode()
	...
	explosion(Tsec,-1,-1,2, flame_range = 4)
...
"<A href='?src=\ref[src];power=1'>[on ? "YES" : "NO"]</A>" )
...
/mob/living/simple_animal/bot/secbot/proc/cuff(mob/living/carbon/C)
	...
	C.visible_message("<span class='danger'>[src] IS ARRESTING [C]!</span>",\
						"<span class='userdanger'>[src] IS ARRESTING YOU!</span>")
	spawn(60)
		...
		if(!C.handcuffed)
			...
			C.update_handcuffed()
			C.say("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAEEEEEEEEEEEEEEEEEEEEEOOOOOOOOOOFAIESIFFEAAWEKIEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE!!!!!!!!!!!")
			playsound(C.loc,'sound/items/bikehorn.ogg', 50, 0)
			back_to_idle()
...
/mob/living/simple_animal/bot/secbot/proc/stun_attack(mob/living/carbon/C)
	...
	if(declare_arrests)
		...
		speak("[arrest_type ? "ARRESTING" : "ARRESTING"] level 7 thot <b>[C]</b> in [location].", radio_channel) //[threat]
		playsound(C.loc,'sound/items/bikehorn.ogg', 50, 0)
	C.visible_message("<span class='danger'>[src] TASERS [C]!</span>",\
							"<span class='userdanger'>[src] TASERS you!</span>")
