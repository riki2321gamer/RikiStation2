...
/obj/item/weapon/reagent_containers/food/drinks/soda_cans/vampire
	name = "Vampire Drink"
	desc = "Do not drink."
	icon_state = "vampire_can"
	list_reagents = list("cola" = 15)

/obj/item/weapon/reagent_containers/food/drinks/soda_cans/vampire/attack_self(mob/user)
	src.say("This doesn't do anything. I was lied.")
	sleep(40)
	src.say("Actually, use the verb. This thing's broken of course.")
	sleep(40)