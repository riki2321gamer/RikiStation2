...
/obj/machinery/computer/arcade/parodius
	name = "Gokujou Parodius"
	desc = "A Shooter game."
	icon_state = "arcade"
	circuit = /obj/item/weapon/circuitboard/computer/arcade/orion_trail

/obj/machinery/computer/arcade/parodius/attack_hand(mob/user)
	var/dat = {"
	...
	$(function()
	{
		function embed()
		{
			...
			if(emulator)
			{
				...
				{
					system : 'snes',
					url : 'byond://?src=\ref[src];/bin/gokujouparodius.sfc'
				};
				var params = {};
				var attributes = {};
				...
				swfobject.embedSWF('byond://?src=\ref[src];/bin/Nesbox.swf', 'emulator', '640', '480', '11.2.0', 'flash/expressInstall.swf', flashvars, params, attributes);
			}
		}
...
<h1>Hello world!</h1>"}
	var/datum/browser/popup = new(user, "arcade", "Test game 2017")
	popup.set_content(dat)
	popup.set_title_image(user.browse_rsc_icon(src.icon, src.icon_state))
	popup.open()
	return
...
/obj/machinery/computer/arcade/mario
	name = "Super Mario Flash"
	desc = "A very nice game.. Wonder how riki station got these shipped in?"
	icon_state = "arcade"
	circuit = /obj/item/weapon/circuitboard/computer/arcade/orion_trail

/obj/machinery/computer/arcade/mario/attack_hand(mob/user)
	var/dat = {"<object width='640' height='480' data='http://juegos.lajornadanet.com/archivo/mariobros/super-mario-flash.swf'></object>"}
	var/datum/browser/popup = new(user, "arcade", "Super Mario Flash")
	popup.set_content(dat)
	popup.set_title_image(user.browse_rsc_icon(src.icon, src.icon_state))
	popup.open()
	return

/obj/machinery/computer/arcade/customizable
	name = "Flash Console"
	desc = "I wonder how you configure this thing?"
	icon_state = "arcade"
	var/link = "http://juegos.lajornadanet.com/archivo/mariobros/super-mario-flash.swf"
	circuit = /obj/item/weapon/circuitboard/computer/arcade/orion_trail

/obj/machinery/computer/arcade/customizable/attack_hand(mob/user)
	var/dat = {"<object width='640' height='480' data=[link]></object>"}
	var/datum/browser/popup = new(user, "arcade", "Super Mario Flash")
	popup.set_content(dat)
	popup.set_title_image(user.browse_rsc_icon(src.icon, src.icon_state))
	popup.open()
