...
/obj/item/weapon/sharksvuvuzela
	name = "sharks vuvuzela"
	desc = "a club penguin item"
	icon = 'icons/obj/items.dmi'
	icon_state = "bike_horn"
	item_state = "bike_horn"
	throwforce = 0
	...
	throw_speed = 16
	throw_range = 255
	attack_verb = list("VUVUZELA'D")
	var/spam_flag = 0
	var/honksound = 'sound/items/sharksvuvuzela.ogg'
	var/cooldowntime = 20
...
/obj/item/weapon/bikehorn/attack(mob/living/carbon/M, mob/living/carbon/user)
	if(!spam_flag)
		user.say("FAAAAKIAAIAIAIIAIAIAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAUOAAAAAAAAAAAAAAAAAFFFFAWWWWWWWWWWWWWWOOOOOOOOOOOOOOOOEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE!!!!")
