...
/obj/item/weapon/grenade/carlsminibomb
	desc = "A grenade of very low power which can destroy atleast 1 tile."
	name = "Carls Grenade"
	icon = 'icons/obj/grenade.dmi'
	icon_state = "syndicate"
	item_state = "flashbang"
...
/obj/item/weapon/grenade/carlsminibomb/prime()
	update_mob()
	explosion(src.loc,0,1,0,flame_range = 1)
	qdel(src)
