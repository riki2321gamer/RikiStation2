...
/obj/item/weapon/grenade/chem_grenade/clf3
	name = "stop"
	desc = "DUDE YOU DONT WANT TO USE THIS BECAUSE I REMOVED ALL THE REAGENTS LOL"
	stage = READY
...
/obj/item/weapon/grenade/chem_grenade/clf3/New()
	...
	B1.reagents.add_reagent("fluorosurfactant", 0)
	B1.reagents.add_reagent("clf3", 0)
	B2.reagents.add_reagent("water", 0)
	B2.reagents.add_reagent("clf3", 0)
