...
/obj/item/weapon/grenade/iedcasing
	name = "firebomb"
	desc = "A strong, explosion device that the captains like."
...
/obj/item/weapon/grenade/iedcasing/attack_self(mob/user) //
	if(!active)
		if(clown_check(user))
			...
			priority_announce("We have detected a IED being light up, please watch out.", "Warning", 'sound/effects/adminhelp.ogg')
			user.say("WATCH THE FUCK OUT IM THROWING A BOMB NIGGERS!!!!!!!!!!")
