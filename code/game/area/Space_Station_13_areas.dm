...
/area/monkey_construction
	name = "Monkey Base Station"
	icon_state = "yellow"
//janitor
/area/centfrick_construction
	name = "CentFrick"
	icon_state = "janitor"

/area/jakesroom
	name = "Jaketheblake's room"
	icon_state = "yellow"

/area/rikishipcustom
	name = "Weird Ship On Riki Station"
	icon_state = "yellow"

/area/carlsroom
	name = "Carl Johnson's room"
	icon_state = "yellow"

/area/aldensroom
	name = "Alden Bluetenberger's room"
	icon_state = "yellow"

/area/monkey_communications
	name = "NSS O Green World."
	icon_state = "yellow"

/area/transit
	name = "Monkey Transit Tubes"
	icon_state = "storage"
...
/area/monkeytower
	name = "Monkey Tower ~ The First Fear ~"
	icon_state = "ai"

/area/killerman
	name = "Monkey Tower ~ The First Fear ~ -.Killer Spawn"
	icon_state = "yellow"

/area/innocentmonkey
	name = "Monkey Tower ~ The First Fear ~ - Innocent Spawn"
	icon_state = "yellow"

/area/freebuild
	name = "Free Build zone"
	icon_state = "yellow"
...
/area/originalrikistation1
	name = "Riki Station 0.5 Prototype"
	icon_state = "yellow"

/area/roundmonkey
	name = "Monkey Tower ~ The First Fear ~ - Round Starter"
	icon_state = "yellow"
